...
# run sample S1_HSN
time ./DLA_DR12_bin2Mpc_80Mpc_sampleS1_HSN.sh > ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleS1_HSN.log 2> ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleS1_HSN.err

# run sample S2_HSN
time ./DLA_DR12_bin2Mpc_80Mpc_sampleS2_HSN.sh > ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleS2_HSN.log 2> ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleS2_HSN.err

# run sample S3_HSN
time ./DLA_DR12_bin2Mpc_80Mpc_sampleS3_HSN.sh > ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleS3_HSN.log 2> ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleS3_HSN.err

# run sample SA_HSN
time ./DLA_DR12_bin2Mpc_80Mpc_sampleSA_HSN.sh > ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleSA_HSN.log 2> ../logs/DLA_DR12_bin2Mpc_80Mpc_sampleSA_HSN.err
