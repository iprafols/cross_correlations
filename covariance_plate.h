...
public:
    ...
    // constructs object and initializes its variables
    CovariancePlate(const int plate_number, const int num_bins, const std::string& results, const std::string& pairs_file_name, const std::vector<int>& plate_neighbours, size_t flag_verbose_correlation_plate, size_t flag_write_partial_results);
    ...
    size_t flag_verbose_correlation_plate() const {return flag_verbose_covariance_plate_;}
